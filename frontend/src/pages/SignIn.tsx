...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Attempt password-based sign-in directly — no verification step
      ...
      if (result.status === "complete") {
        ...
        // Should not happen when email verification is off,
        // but handle gracefully just in case
        setError(`Unexpected sign-in status: ${result.status}. Please try again.`);
      }
    } catch (err: any) {
      const msg =
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">Sign in to SkillBridge</p>
        </div>
